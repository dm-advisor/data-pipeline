...
1Ingesting files into AWS Simple Storage Service (S3) object store in raw form
2Transforming the ingested data 
3Curating and shaping data for BI reporting and analysis consumption.
