#!/bin/bash
##################################################################################################
# This script can be used to revoke permissions using Lake Formation data cells filters for
# a project.
#
...
do
  ...
  info "Now revoking ${perms} from role ARN: ${role_arn} on table: ${table_name}, in database: ${db_name},"
