#!/bin/bash
##################################################################################################
# This script can be used to create Lake Formation tags for a project.
#
...
if [ "$#" -ne 1 ]; then
  ...
  printf "\nExample: %s ../../config/lakeformation/tags/create_lf_tag.csv" "$SCRIPT_NAME"
  exit 1
fi
...
json_template="../../config/lakeformation/tags/create_lf_tag_template.json"
